...
class ViewModelState constructor(
    ...
    companion object {
        ...
        fun error_default(): ViewModelState {
            return ViewModelState(Status.ERROR)
        }
        ...
        fun sub_success5(): ViewModelState {
            return ViewModelState(Status.SUB_SUCCESS5)
        }
        ...
        fun tableNotAvailable(): ViewModelState {
            return ViewModelState(Status.TABLE_NOT_AVAILABLE)
        }
