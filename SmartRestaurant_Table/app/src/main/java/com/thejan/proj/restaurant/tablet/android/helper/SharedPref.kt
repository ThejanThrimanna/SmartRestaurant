...
import com.thejan.proj.restaurant.tablet.android.Restaurant
...
object SharedPref {
    ...
    const val FILE_KEY = "restaurant.file.key"
    ...
    const val NUMBER_OF_SEATS = "restaurant.file.key.is.number.of.seats"
