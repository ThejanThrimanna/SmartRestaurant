...
import com.thejan.proj.restaurant.admin.android.viewmodel.CategoryReportViewModel
...
class CategoryReportActivity : BaseActivity() {
    private lateinit var mViewModel: CategoryReportViewModel
    ...
    private fun initViewModel() {
        mViewModel = ViewModelProviders.of(this).get(CategoryReportViewModel::class.java)
    }
