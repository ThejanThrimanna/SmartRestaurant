package com.thejan.proj.restaurant.tv.smartrestaurant_mobile.helper

import android.content.Context
import com.thejan.proj.restaurant.tv.smartrestaurant_mobile.Restaurant
...
object SharedPref {
    ...
    const val FILE_KEY = "restaurant.mobile.file.key"
    const val IS_LOGIN = "restaurant.file.key.is.login"
    const val PHONE = "restaurant.file.key.is.phone"
    const val NAME = "restaurant.file.key.is.name"
    const val TABLE_NUMBER = "restaurant.file.key.is.table.number"
