...
import com.thejan.proj.restaurant.tv.smartrestaurant_mobile.helper.IV
import com.thejan.proj.restaurant.tv.smartrestaurant_mobile.helper.SALT
import com.thejan.proj.restaurant.tv.smartrestaurant_mobile.helper.SECRET_KEY
...
//        Picasso.get().load(url).error(R.drawable.ic_error).into(iv)
    }
